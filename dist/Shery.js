...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("ControlKit"), require("THREE"), require("gsap"));
	else if(typeof define === 'function' && define.amd)
		define("Shery", ["ControlKit", "THREE", "gsap"], factory);
	else if(typeof exports === 'object')
		exports["Shery"] = factory(require("ControlKit"), require("THREE"), require("gsap"));
	else
		root["Shery"] = factory(root["ControlKit"], root["THREE"], root["gsap"]);
})(self, (__WEBPACK_EXTERNAL_MODULE__160__, __WEBPACK_EXTERNAL_MODULE__824__, __WEBPACK_EXTERNAL_MODULE__163__) => {
...
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ Shery),
  hoverWithMediaCircle: () => (/* reexport */ hoverWithMediaCircle),
  imageEffect: () => (/* reexport */ imageEffect),
  imageMasker: () => (/* reexport */ imageMasker),
  makeMagnet: () => (/* reexport */ makeMagnet),
  mouseFollower: () => (/* reexport */ mouseFollower),
  textAnimate: () => (/* reexport */ textAnimate)
});

// NAMESPACE OBJECT: ./src/Effects.js
var Effects_namespaceObject = {};
__webpack_require__.r(Effects_namespaceObject);
__webpack_require__.d(Effects_namespaceObject, {
  hoverWithMediaCircle: () => (hoverWithMediaCircle),
  imageEffect: () => (imageEffect),
  imageMasker: () => (imageMasker),
  makeMagnet: () => (makeMagnet),
  mouseFollower: () => (mouseFollower),
  textAnimate: () => (textAnimate)
});

// EXTERNAL MODULE: external "gsap"
var external_gsap_ = __webpack_require__(163);
var external_gsap_default = /*#__PURE__*/__webpack_require__.n(external_gsap_);
// EXTERNAL MODULE: external "THREE"
var external_THREE_ = __webpack_require__(824);
// EXTERNAL MODULE: external "ControlKit"
var external_ControlKit_ = __webpack_require__(160);
var external_ControlKit_default = /*#__PURE__*/__webpack_require__.n(external_ControlKit_);
...
const redraw = (plane, v) => {
  let newGeometry = new external_THREE_.PlaneGeometry(
...
const init = (
  ...
  const mousem = new external_THREE_.Vector2()
  const scene = new external_THREE_.Scene()
  const camera = new external_THREE_.PerspectiveCamera(fov, aspect, 0.1, 2)
  camera.position.z = 1
  const t = []
  ...
  if (!(elem.nodeName.toLowerCase() === "img")) {
    ...
    if (!opts.slideStyle) {
      if (opts.staticScroll) {
        function handleScroll(deltaY) {
          external_gsap_default().to(scrollProps, {
    ...
    for (let i = 0; i < elem.children.length; i++) {
      t[i] = new external_THREE_.TextureLoader().load(
    ...
    uTexture: {
      value:
        elem.nodeName.toLowerCase() === "img"
          ? [new external_THREE_.TextureLoader().load(elem.getAttribute("src"))]
          : [t[0], t[1]],
    },
  })
  ...
  const renderer = new external_THREE_.WebGLRenderer({ antialias: true, alpha: true })
  ...
  const plane = new external_THREE_.Mesh(
    new external_THREE_.PlaneGeometry(size, size, geoVertex, geoVertex),
    new external_THREE_.ShaderMaterial({
  ...
  const config = (c) => {
    if (c.color) c.color.value = new external_THREE_.Color(c.color.value)
  ...
  if ((opts.debug && !isdebug[effect]) || false) {
    isdebug[effect] = true
    controlKit = new (external_ControlKit_default())()
  ...
  const clock = new external_THREE_.Clock()
  function animate() {
    setCanvasPos()
    ...
    Object.assign(uniforms, {
      ...
      mousem: { value: mousem },
      uIntercept: {
        value: external_THREE_.MathUtils.lerp(
...
var Power0 = _easeMap.Power0,
    gsap_core_Power1 = _easeMap.Power1,
...
function mouseFollower(opts = {}) {
    ...
    window.addEventListener("mousemove", function (dets) {
        if (opts.skew) {
            diff = external_gsap_default().utils.clamp(15, 35, dets.clientX - posx)
            posx = dets.clientX
            external_gsap_default().to(".mousefollower", {
                width: diff + "px",
...
function imageMasker(element = "img", opts = {}) {
    document.querySelectorAll(element).forEach(function (elem) {
        ...
        if (opts.mouseFollower) {
            ...
            circle.style.width = external_gsap_default().utils.clamp(50, 70, elem.getBoundingClientRect().width * 0.3) + "px"
            circle.style.height = external_gsap_default().utils.clamp(50, 70, elem.getBoundingClientRect().width * 0.3) + "px"
            ...
            circle.classList.add("circle")
                ...
                .addEventListener("mouseenter", function () {
                    external_gsap_default().to(circle, {
                        opacity: 1,
                        ease: Expo.easeOut,
                        duration: 1,
                    })
        ...
        mask.addEventListener("mouseenter", function () {
            external_gsap_default().to(globalMouseFollower, {
                opacity: 0,
                ease: Power1,
            })
        })
        mask.addEventListener("mousemove", function (dets) {
            external_gsap_default().to(elem, {
        ...
        mask.addEventListener("mouseleave", function () {
            ...
            external_gsap_default().to(this.childNodes[0], {
                scale: 1,
                ease: opts.ease || Expo.easeOut,
                duration: opts.duration || 1,
            })
...
// SECTION - Make Magnet 
function makeMagnet(element, opts = {}) {
    document.querySelectorAll(element).forEach(function (elem) {
        elem.addEventListener("mousemove", function (dets) {
            var bcr = elem.getBoundingClientRect()
            var zeroonex = external_gsap_default().utils.mapRange(0, bcr.width, 0, 1, dets.clientX - bcr.left)
            var zerooney = external_gsap_default().utils.mapRange(0, bcr.height, 0, 1, dets.clientY - bcr.top)
        ...
        elem.addEventListener("mouseleave", function (dets) {
            ...
            external_gsap_default().to(elem, { x: 0, y: 0, duration: opts.duration || 1, ease: opts.ease || Expo.easeOut, })
        })
    })
} //!SECTION 

// SECTION - Text Animate 
function textAnimate(element, opts = {}) {
    ...
    switch (opts.style || 1) {
        case 1:
            alltexts.forEach(function (elem) {
                external_gsap_default().from(elem.childNodes, {
                    scrollTrigger: {
                        trigger: elem,
                        start: "top 80%",
                    },
...
function hoverWithMediaCircle(element, opts) {
    ...
    document.querySelectorAll(element)
        .forEach(function (elem, index) {
            ...
            elem.addEventListener("mousemove", function (dets) {
                ...
                var trans = external_gsap_default().utils.pipe(
                    external_gsap_default().utils.clamp(-1, 1),
                    external_gsap_default().utils.mapRange(-1, 1, .8, 1.2)
                )
                ...
                timer = setTimeout(function () {
                    external_gsap_default().to(".movercirc", {
...
function imageEffect(element = "img", opts = {}) {
    document.querySelectorAll(element).forEach(function (elem) {
        if (!(elem.nodeName.toLowerCase() === 'img')) {
            ...
            setDisplayOld(window.getComputedStyle(elem).display)
            elem.style.visibility = 'hidden'
        }
        ...
        switch (opts.style || 1) {
          ...
          gl_FragColor=final;          
                ...
                var { debugObj, controlKit, panel, uniforms, animate } = init(elem, vertex, fragment, {
                    resolution: { value: new external_THREE_.Vector2(getSize(elem).width, getSize(elem).height) },
                    ...
                    color: { value: new external_THREE_.Color(0.33, 0.66, 1) },
...
;// CONCATENATED MODULE: ./src/Shery.js





/* harmony default export */ const Shery = (Effects_namespaceObject);
})();
